...
const SendEmailCAdmin = async (title, fname, sname) => {
  try {
    const result = await emailjs.send(
      ...
      "template_pc4lp4l",
      {
        ...
        header: "Request has been Cancel",
        subject: "Request has been Cancel from",
        to_email: "info@magichand.co.uk",
        title: title,
        f_name: fname,
        l_name: sname,
        from_name: "Magic Hand",
        message: `${title} ${fname} ${sname} new Request has been Cancel.
                        ...
                        >
                          <a
                            ...
                            "
                            href="https://magichandapp.co.uk/admin/cancel"
                            target="_blank"
                            rel="noopener"
...
export default SendEmailCAdmin;
